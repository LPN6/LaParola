	...
	function load_more() {
		...
		if (speedDelta == 0) {
			...
			if (below_bottom < node_height*2) {
				...
				//console.log('load prev1', fragmentid);
			...
			// add above
				...
				//console.log('load prev2', fragmentid, sections.length);
			...
			// remove above
			else if (above_top > node_height*50) { // lpnrmw was 15, but sometimes in commentaries (Jonah 1 in TSK) it kept removing the text above immediately after creating it
				//console.log('remove above', above_top, node_height);
			...
			// remove below
				...
				//console.log('remove below', below_bottom, node_height);
...
//console.log(loadType, sectionid, fragmentid);
		...
		//console.log('load', loadType, sectionid, fragmentid);
