...
<!--        <p style="text-align:left"><label>Brano da visualizzare:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="text" name="riferimento" id="riferimento" title="Digita qui il riferimento di un brano" /></label></p>-->
<div>
	<p style="text-align:left">
	<label for="libri">Brano da visualizzare:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
    <input class="text" name="riferimento" id="libri" title="Digita qui il riferimento di un brano" tabindex="1" value="<? echo $riferimento==$riferimento_predefinito?"":($homepage=="s"?utf8_encode($riferimento):htmlentities(urldecode($riferimento), 0, "ISO-8859-1"));?>" />
    </p>
</div>
        <p style="text-align:left"><label for="versioni">Testo/i da visualizzare:</label><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<noscript>
        ...
        <input class="submit tabella" type="submit" name="Submit" value="Visualizza testo" tabindex="4" />
<!--        <input class="reset" type="reset" name="Reset" value="Annulla" />-->
        <p style="text-align:center"><a href="aiutovis.php" title="Come digitare un riferimento e mostrare un brano" tabindex="5"><img src="/immagini/qmark.gif" width="20" height="20" alt="Aiuto" /> Aiuto per visualizzare la Bibbia</a></p>
    </fieldset>
        </form>
...
<div class="modulo moduloRic">        
    ...
    <legend><strong>Ricercare nella Bibbia</strong></legend>
        <div>
        <p style="text-align:left"><label for="frase">Parola o frase da ricercare:</label><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="text" name="frase" title="Digita qui una o pi&ugrave; parole" tabindex="6" value="<? echo str_replace("\\\\","&#92;",utf8_encode($frase));?>" /></label></p>
        </div>
        <p style="text-align:left"><label for="versione">Versione da ricercare:</label><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<noscript>
        ...
        <div>
        <p style="text-align:left"><label>Brano in cui ricercare:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="text" type="text" name="brano" title="Digita qui un riferimento (facoltativo)" tabindex="8" value="<? echo ($homepage=="s"?$brano:utf8_decode($brano))?>" /></label></p>
        </div>
        <p style="text-align:center"><a href="/ricerca_avanzata.php" tabindex="9">Ricerca avanzata</a></p>
        <input class="submit tabella" type="submit" name="Submit" value="Ricerca" tabindex="10" />
<!--        <input class="reset" type="reset" name="Reset" value="Annulla" />-->
        <p style="text-align:center"><a href="aiutoric.php" title="I codici da usare per ricerche complicate" tabindex="11"><img src="/immagini/qmark.gif" width="20" height="20" alt="Aiuto" /> Aiuto per ricercare la Bibbia</a></p>
    </fieldset>
        </form>
