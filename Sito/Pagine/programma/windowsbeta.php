...
<p>Bisogna <a href="/file/laparola8.exe">scaricare l'app beta</a> in una qualsiasi cartella.
Non serve l'installazione; basta avviare il file scaricato.
Possibilmente (dipende dalle app che hai gi&agrave; installato) ti dir&agrave; che devi prima installare
un componente facoltativo di Windows (.NET Desktop Runtime versione 8);
in quel caso segui le istruzioni per scaricare e avviare il programma per installare il componente.</p>
...
<li>Testo ebraico visualizzato bene. Una conseguenza &egrave; che &egrave; possibile visualizzare il testo ebraico un versetto dopo l'altro e che altro testo in caratteri latini pu&ograve; essere inserito.
...
(con i file dei testi sulla stessa chiavetta).</li>
...
<p>Per i programmatori, non solo &egrave; il codice sorgente disponibile <a href="https://github.com/LPN6/LaParola/tree/main/Codice%20sorgente">qui</a>, ma
