    ...
    private IShellLinkA m_Link;
...
#if UNICODE
            m_Link = (IShellLinkW)new ShellLinkClass();
#else
      m_Link = (IShellLinkA) new ShellLink();
        ...
        public string Path
        {
            ...
            {
#if UNICODE
                Win32FindDataW wfd = new Win32FindDataW();
#else
        WIN32_FIND_DATAA wfd = new WIN32_FIND_DATAA();
#endif
                StringBuilder sb = new StringBuilder(MAX_PATH);

                m_Link.GetPath(sb, sb.Capacity, out wfd, SlgpTypes.SlgpUncPriority);
                return sb.ToString();
            }
        ...
        public Icon Icon
        {
            get
            {
                ...
                hIcon = SafeNativeMethods.ExtractIcon(hInst, sb.ToString(), nIconIdx);
