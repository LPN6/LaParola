...
/* package */ class LaParolaTesto {
    ...
    private static final LruCache<String, CharSequence> mCache = new LruCache<>(CACHE_SIZE);
        ...
        if (BuildConfig.DEBUG && mDebugFileName != null) {
            try {
                if (res != null) {
                    ...
                    out.close();
                    Timber.tag("LaParola").d(res.toString());
                }
            } catch (Exception e) {
                Timber.e(e, "Unexpected error occurred while getting Brano.");
            }
        }
    ...
    private CharSequence getBranoLaParola(final LaParolaUrl url, Riferimento rif, String errore) {
        ...
        if (urlrif != null) {
            ...
            if (url.brani != null && url.brani.startsWith("$")) {
                ...
                res = Objects.requireNonNullElse(url.testo, "");
            }
        }
        ...
        if (res instanceof StringBuilder sb) {
    ...
    private static String leggiFile(String filename) {
        ...
        try {
            ...
            InputStreamReader fin = new InputStreamReader(inp, StandardCharsets.ISO_8859_1);
            ...
            Timber.e(e, "Unexpected error occurred while reading file.");
            return null;
        }
