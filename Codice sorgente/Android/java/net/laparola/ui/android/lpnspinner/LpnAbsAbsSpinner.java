 ...
 */
public abstract class LpnAbsAbsSpinner extends LpnAdapterView<SpinnerAdapter> {
    ...
    public LpnAbsAbsSpinner(Context context) {
        super(context);
        initAbsSpinner();
    }

    public LpnAbsAbsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LpnAbsAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
