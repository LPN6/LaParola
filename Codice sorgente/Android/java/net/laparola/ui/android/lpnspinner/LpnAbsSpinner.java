 ...
 */
public abstract class LpnAbsSpinner extends LpnAbsAbsSpinner implements OnClickListener {
    ...
    private LpnDropDownAdapter mTempAdapter;
    int mDropDownWidth;
    ...
    public abstract LpnDropdownPopup createPopup(Context context, AttributeSet attrs, int defStyle);

    public LpnAbsSpinner(Context context, AttributeSet attrs) {
     ...
     */
    public LpnAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
        ...
        LpnDropdownPopup popup = createPopup(context, attrs, defStyle);
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        ...
        if (mPopup != null) {
            mPopup.setAdapter(new LpnDropDownAdapter(adapter));
        } else {
            mTempAdapter = new LpnDropDownAdapter(adapter);
        }
    }
    ...
    */
	...
	public boolean isPopupCentered() {
		if (!(mPopup instanceof LpnPopupWindow))
			return false;
		return ((LpnPopupWindow)mPopup).isCentered();
	}

	public void setPopupCentered(boolean value) {
		if (mPopup instanceof LpnPopupWindow)
			((LpnPopupWindow)mPopup).setCentered(value);
	}
}
