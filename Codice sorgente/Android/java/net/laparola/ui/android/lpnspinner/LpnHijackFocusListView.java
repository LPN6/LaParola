...
public abstract class LpnHijackFocusListView extends FrameLayout {
    /*
    ...
    public LpnHijackFocusListView(Context context, boolean hijackFocus) {
        super(context);
    ...
    public void setOnScrollListener(LpnPopupWindow.PopupScrollListener listener) {
    ...
    protected int getNumColumns(int widthMeasureSpec) {
        if (mListView instanceof GridView gridView) {
            int t;
    ...
    protected int getDividerHeight() {
        if (mListView instanceof ListView lw) {
            if ((lw.getDividerHeight() > 0) && lw.getDivider() != null)
                return lw.getDividerHeight();
        } else if (mListView instanceof GridView gridView) {
    ...
    private int getPrivateFieldInt(Object obj, String field, int defaultValue) {
        try {
            ...
            Timber.e(e, "Unexpected  error occurred while getting private field.");
            return defaultValue;
        }
    }
