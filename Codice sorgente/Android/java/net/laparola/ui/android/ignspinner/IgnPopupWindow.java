...
public abstract class IgnPopupWindow {
    ...
    public IgnPopupWindow(Context context) {
        this(context, null, 0);

        initRunnables();
    }

    public IgnPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        mContext = context;
    ...
    public IgnPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        mContext = context;
