...
public class HoloDialog extends Dialog implements android.view.View.OnClickListener {
	...
	public HoloDialog(Context context, boolean isAlert) {
		super(context, R.style.Theme_IgnazioHolo_Dialog);
		mContext = context;

		if (Build.VERSION.SDK_INT < 11 || isAlert) {
