...
public class VersionAdapter implements SpinnerAdapter, ListAdapter {
	...
	private List<ComponenteInformazioni> mTestiFiltrati;
	private TestoTipi mTipo = TestoTipi.NESSUNO;
	
	private LayoutInflater mInflater;
	private List<ComponenteInformazioni> mTestiInstallati;
	private Comparator<ComponenteInformazioni> mComparator;
	...
	public VersionAdapter (Context c) {
		...
		mTestiFiltrati = new ArrayList<ComponenteInformazioni>();
		
		mComparator = new Comparator<ComponenteInformazioni>() {
			@Override
			public int compare(ComponenteInformazioni lhs, ComponenteInformazioni rhs) {
				return lhs.getComponente().compareTo(rhs.getComponente());
			}
		};
	}
	...
	public void refresh() {
		...
		Collections.sort(mTestiInstallati, mComparator);
