...
public class TTSActionItemManager implements OnActionExpandListener, OnClickListener, TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener {
	...
	public TTSActionItemManager(LaParolaActivity parent, MenuItem item) {
        this.parent = parent;
        ...
        mPopup.setBackgroundDrawable(parent.getResources().getDrawable(R.drawable.abs__menu_dropdown_panel_holo_light));
				...
				if (mParentFragment != null && mParentFragment.isVisible()) {
					...
					if (urlCorrente != null) {
						...
						if (urlSuccessivo != null) {
							...
							mParentFragment.onProssimaPaginaCaricata = new Runnable() {
								@Override
								public void run() {
									readTTS();
								}
