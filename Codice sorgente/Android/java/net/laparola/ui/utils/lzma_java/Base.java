...
public class Base {
    ...
    //public static final int kDicLogSizeMin = 0;	// public static final int kDicLogSizeMax = 28;	// public static final int kDistTableSizeMax = kDicLogSizeMax * 2;
    ...
    //public static final int kAlignTableSize = 1 << kNumAlignBits;	//public static final int kAlignMask = (kAlignTableSize - 1);
    ...
    //public static final  int kNumPosStatesBitsEncodingMax = 4;	//public static final  int kNumPosStatesEncodingMax = (1 << kNumPosStatesBitsEncodingMax);
    ...
    //public static final  int kNumLenSymbols = kNumLowLenSymbols + kNumMidLenSymbols +(1 << kNumHighLenBits);	//public static final  int kMatchMaxLen = kMatchMinLen + kNumLenSymbols - 1;
}
